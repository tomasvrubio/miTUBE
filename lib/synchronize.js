...
module.exports = function(){
    ...
    //Se encarga de revisar que canciones se han modificado en la lista de YT. Podemos tener canciones que ya no estén o canciones nuevas.    
        return new Promise((resolve, reject) => {
            Promise.all([
                ...
                //TODO: Antes o después de borrarlas debería hacer algo con ellas. Mandarlas a la tabla de work para realizar su baja!!!
                ...
                List.findOneAndUpdate({listId:listId},
                    ...
                    function(err){
                        ...
                        loger.debug(listId+" - Songs added: "+newSongs.length);
                        
                        generateWorkUpload(listId).then(returnObject => {
                            logger.debug(listId+" - Songs inserted in WorkTodo");
                        }).catch(err => {
    ...
    function checkUpdatedUser(apiKey, email) {
        return new Promise((resolve, reject) => {
            loger.debug(email+" - Check the lists of the user");
        ...
        return new Promise((resolve, reject) => {
            Promise.all([
                ...
                relations.forEach(function(relation, index){
                    ...
                    logger.debug("Songs for new work:");
