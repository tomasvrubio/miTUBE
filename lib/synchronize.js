...
module.exports = function(){
    ...
    return {
        ...
        createList: function(apiKey, listId, nameYT) {
            ...
            return new Promise((resolve, reject) => {
                //TODO: Comprobar que la lista no existe. Si ya existe (creada por otro usuario) dar la función por finalizada OK. TODO: Comprobar qeu funciona lo introducido
