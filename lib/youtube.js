...
module.exports = function(){
    ...
    //TODO: A ELIMINAR TRAS COMPROBAR QUE PLAYLISTETAG VA BIEN
    // function playlistModified(playlistId, callback) {
    //     youtube.playlistItems.list({
    //         part: 'id',
    //         playlistId: playlistId,
    //         pageToken: null,
    ...
    return {
        ...
        //TODO: A ELIMINAR TRAS VERIFICAR QUE listEtag VA BIEN
        // listModified: function(apiKey, playlistId) {
        //     return new Promise((resolve, reject) => {                
        //         if (!apiKey) return reject(new Error('No API Key Provided'));
        //         if (!playlistId) return reject(new Error('No Playlist ID Provided'));
        //         youtube.authenticate({
        ...
        //             key: apiKey
        //         });
        //         playlistModified(playlistId, (err, data) => {
        //           if (err) return reject(err);
